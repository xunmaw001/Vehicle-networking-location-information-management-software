    ...
    <el-tabs tab-position="left" :style='{"border":"1px solid #ddd","width":"100%","padding":"30px 20px","margin":"20px auto 0 auto","borderRadius":"16px","background":"#fff"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,244,218,1) 0%, rgba(254,244,218,1) 51%, rgba(255,234,178,1) 51%, rgba(255,234,178,1) 100%)"}' v-if="userTableName=='yonghu'" label="年龄" prop="nianling">
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,244,218,1) 0%, rgba(254,244,218,1) 51%, rgba(255,234,178,1) 51%, rgba(255,234,178,1) 100%)"}' v-if="userTableName=='yonghu'" label="用户手机" prop="yonghushouji">
            <el-input v-model="sessionForm.yonghushouji" placeholder="用户手机" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,244,218,1) 0%, rgba(254,244,218,1) 51%, rgba(255,234,178,1) 51%, rgba(255,234,178,1) 100%)"}' v-if="userTableName=='yonghu'" label="驾驶证" prop="jiashizheng">
            <el-input v-model="sessionForm.jiashizheng" placeholder="驾驶证" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,244,218,1) 0%, rgba(254,244,218,1) 51%, rgba(255,234,178,1) 51%, rgba(255,234,178,1) 100%)"}' v-if="userTableName=='yonghu'" label="身份证" prop="shenfenzheng">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.sessionForm, 'jiashizheng', null);
      }
      if ('yonghu' == this.userTableName) {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'yonghushouji', [{ required: true, message: '请输入用户手机', trigger: 'blur' }]);
      }
			if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'yonghushouji', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
      }
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'jiashizheng', [{ required: true, message: '请输入驾驶证', trigger: 'blur' }]);
      }
      if ('yonghu' == this.userTableName) {
